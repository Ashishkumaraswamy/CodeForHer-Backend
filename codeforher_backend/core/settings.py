...
from codeforher_backend.schema.models import (AllModelEnum, AnthropicModelName, AWSModelName,
                           ...
                           OllamaModelName, OpenAIModelName, Provider)
...
class Settings(BaseSettings):
    ...
    OPENAI_API_KEY: SecretStr | None = "3e33b1a703db4eaf800657cfff73e2db"
    ...
    AZURE_OPENAI_API_KEY: SecretStr | None = "42b77c0176b64954a8449653d88abb8a"
    ...
    def __init__(self, **kwargs):
        ...
        print(
            f"AZURE_OPENAI_DEPLOYMENT_MAP: {os.getenv('AZURE_OPENAI_DEPLOYMENT_MAP')}"
        )
        print(f"Current working directory: {os.getcwd()}")
        print(f"Environment file location: {find_dotenv()}")
